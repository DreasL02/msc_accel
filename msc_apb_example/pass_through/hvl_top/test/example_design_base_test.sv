...
function void example_design_base_test::setup_apb_slave_agent_config();
  env_cfg_h.apb_slave_agent_cfg_h = apb_config::type_id::create("apb_slave_agent_config");

  env_cfg_h.apb_slave_agent_cfg_h.c_type_id          = 0;
  env_cfg_h.apb_slave_agent_cfg_h.c_id               = 2;
  env_cfg_h.apb_slave_agent_cfg_h.c_name             = "SLAVE";
  env_cfg_h.apb_slave_agent_cfg_h.c_is_active        = UVM_ACTIVE;
  env_cfg_h.apb_slave_agent_cfg_h.c_is_tx            = 1'b0;
  env_cfg_h.apb_slave_agent_cfg_h.c_coverage_enable  = 1'b0;
  env_cfg_h.apb_slave_agent_cfg_h.c_error_is_ignored = 1'b1;
  env_cfg_h.apb_slave_agent_cfg_h.c_expect_errors    = 1'b0;
  env_cfg_h.apb_slave_agent_cfg_h.use_accel = env_cfg_h.enable_accel;
  ...
  env_cfg_h.apb_slave_agent_cfg_h.accel_driver_config_h.protocol_identifier = 1;
  env_cfg_h.apb_slave_agent_cfg_h.accel_driver_config_h.wait_for_response = 1;
  ...
  env_cfg_h.apb_slave_agent_cfg_h.accel_monitor_config_h.request_protocol_identifier = 3;
  env_cfg_h.apb_slave_agent_cfg_h.accel_monitor_config_h.response_protocol_identifier = 2;
