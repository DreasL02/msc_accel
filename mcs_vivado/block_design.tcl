...
proc create_hier_cell_constants { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_constants() - Empty argument(s)!"}
     return
  }
  ...
  set_property CONFIG.CONST_VAL {1} $xlconstant_5


  # Create port connections
  connect_bd_net -net Net [get_bd_pins xlconstant_1/dout] [get_bd_pins config_valid]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins phy_addr]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconstant_2/dout] [get_bd_pins config_vector]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconstant_3/dout] [get_bd_pins an_adv_config_vec]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconstant_4/dout] [get_bd_pins signal_detect]
  connect_bd_net -net xlconstant_5_dout [get_bd_pins xlconstant_5/dout] [get_bd_pins sfp_tx_dis]
...
proc create_root_design { parentCell } {
  ...
  set probe21_0 [ create_bd_port -dir I -from 0 -to 0 probe21_0 ]
  set probe18_0 [ create_bd_port -dir I -from 0 -to 0 probe18_0 ]
  set probe9_0 [ create_bd_port -dir I -from 31 -to 0 probe9_0 ]
  set probe16_0 [ create_bd_port -dir I -from 0 -to 0 probe16_0 ]
  set probe22_0 [ create_bd_port -dir I -from 0 -to 0 probe22_0 ]
  set probe15_0 [ create_bd_port -dir I -from 31 -to 0 probe15_0 ]
  set probe31_0 [ create_bd_port -dir I -from 0 -to 0 probe31_0 ]
  set probe14_0 [ create_bd_port -dir I -from 31 -to 0 probe14_0 ]
  set probe17_0 [ create_bd_port -dir I -from 0 -to 0 probe17_0 ]
  set probe3_0 [ create_bd_port -dir I -from 199 -to 0 probe3_0 ]
  set probe27_0 [ create_bd_port -dir I -from 0 -to 0 probe27_0 ]
  set probe20_0 [ create_bd_port -dir I -from 0 -to 0 probe20_0 ]
  set probe13_0 [ create_bd_port -dir I -from 31 -to 0 probe13_0 ]
  set probe10_0 [ create_bd_port -dir I -from 31 -to 0 probe10_0 ]
  set probe7_0 [ create_bd_port -dir I -from 199 -to 0 probe7_0 ]
  set probe2_0 [ create_bd_port -dir I -from 199 -to 0 probe2_0 ]
  set probe12_0 [ create_bd_port -dir I -from 31 -to 0 probe12_0 ]
  set probe19_0 [ create_bd_port -dir I -from 0 -to 0 probe19_0 ]
  set probe5_0 [ create_bd_port -dir I -from 199 -to 0 probe5_0 ]
  set probe0_0 [ create_bd_port -dir I -from 199 -to 0 probe0_0 ]
  set probe29_0 [ create_bd_port -dir I -from 0 -to 0 probe29_0 ]
  set probe26_0 [ create_bd_port -dir I -from 0 -to 0 probe26_0 ]
  set probe6_0 [ create_bd_port -dir I -from 199 -to 0 probe6_0 ]
  set probe1_0 [ create_bd_port -dir I -from 199 -to 0 probe1_0 ]
  set probe30_0 [ create_bd_port -dir I -from 0 -to 0 probe30_0 ]
  set probe28_0 [ create_bd_port -dir I -from 0 -to 0 probe28_0 ]
  set probe4_0 [ create_bd_port -dir I -from 199 -to 0 probe4_0 ]
  set probe11_0 [ create_bd_port -dir I -from 31 -to 0 probe11_0 ]
  set probe25_0 [ create_bd_port -dir I -from 0 -to 0 probe25_0 ]
  set probe8_0 [ create_bd_port -dir I -from 31 -to 0 probe8_0 ]
  set probe24_0 [ create_bd_port -dir I -from 0 -to 0 probe24_0 ]
  set probe23_0 [ create_bd_port -dir I -from 0 -to 0 probe23_0 ]
  ...
  set_property CONFIG.Output_Width {12} $c_counter_binary_1
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#TTC 0#TTC 0#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#I2C 0#I2C 0#I2C 1#I2C 1#UART 0#UART\
0#UART 1#UART 1#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SD 1#SD 1#SD 1#SD\
1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1##########################} \
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.C_PROBE1_WIDTH {200} \
    CONFIG.C_PROBE20_WIDTH {1} \
    CONFIG.C_PROBE23_WIDTH {1} \
    CONFIG.C_PROBE24_WIDTH {1} \
    CONFIG.C_PROBE26_WIDTH {1} \
    CONFIG.C_PROBE2_WIDTH {200} \
    CONFIG.C_PROBE3_WIDTH {200} \
    CONFIG.C_PROBE4_WIDTH {200} \
    CONFIG.C_PROBE5_WIDTH {200} \
    CONFIG.C_PROBE6_WIDTH {200} \
    CONFIG.C_PROBE7_WIDTH {200} \
  ...
  connect_bd_intf_net -intf_net S_AXIS_0_1 [get_bd_intf_ports S_AXIS_0] [get_bd_intf_pins axis_dwidth_converter_1/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets S_AXIS_0_1] [get_bd_intf_ports S_AXIS_0] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_7_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_1_M_AXIS] [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_0_M_AXIS] [get_bd_intf_ports M_AXIS_0] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_dwidth_converter_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_1_M_AXIS [get_bd_intf_pins axis_dwidth_converter_1/M_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_1_M_AXIS] [get_bd_intf_pins axis_dwidth_converter_1/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_FPD] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets zynq_ultra_ps_e_0_M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins constants/config_valid] [get_bd_pins gig_ethernet_pcs_pma_0/configuration_valid] [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_val] [get_bd_pins gig_ethernet_pcs_pma_0/an_restart_config]
  connect_bd_net -net Net1 [get_bd_pins zynq_ultra_ps_e_0/emio_enet0_mdio_mdc] [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins gig_ethernet_pcs_pma_0/mdc]
  connect_bd_net -net Net2 [get_bd_pins zynq_ultra_ps_e_0/emio_gpio_o] [get_bd_pins xlslice_5/Din]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_gmii_rxclk [get_bd_pins gig_ethernet_pcs_pma_0/gmii_rxclk] [get_bd_pins c_counter_binary_2/CLK] [get_bd_pins zynq_ultra_ps_e_0/emio_enet0_gmii_rx_clk]
  connect_bd_net -net gig_ethernet_pcs_pma_0_resetdone [get_bd_pins gig_ethernet_pcs_pma_0/resetdone] [get_bd_ports xcvr_rst_done_led]
  ...
  connect_bd_net -net gig_ethernet_pcs_pma_0_userclk2_out [get_bd_pins gig_ethernet_pcs_pma_0/userclk2_out] [get_bd_pins c_counter_binary_0/CLK]
  connect_bd_net -net probe0_0_1 [get_bd_ports probe0_0] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net probe10_0_1 [get_bd_ports probe10_0] [get_bd_pins system_ila_0/probe10]
  connect_bd_net -net probe11_0_1 [get_bd_ports probe11_0] [get_bd_pins system_ila_0/probe11]
  connect_bd_net -net probe12_0_1 [get_bd_ports probe12_0] [get_bd_pins system_ila_0/probe12]
  connect_bd_net -net probe13_0_1 [get_bd_ports probe13_0] [get_bd_pins system_ila_0/probe13]
  connect_bd_net -net probe14_0_1 [get_bd_ports probe14_0] [get_bd_pins system_ila_0/probe14]
  connect_bd_net -net probe15_0_1 [get_bd_ports probe15_0] [get_bd_pins system_ila_0/probe15]
  connect_bd_net -net probe16_0_1 [get_bd_ports probe16_0] [get_bd_pins system_ila_0/probe16]
  connect_bd_net -net probe17_0_1 [get_bd_ports probe17_0] [get_bd_pins system_ila_0/probe17]
  connect_bd_net -net probe18_0_1 [get_bd_ports probe18_0] [get_bd_pins system_ila_0/probe18]
  connect_bd_net -net probe19_0_1 [get_bd_ports probe19_0] [get_bd_pins system_ila_0/probe19]
  connect_bd_net -net probe1_0_1 [get_bd_ports probe1_0] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net probe20_0_1 [get_bd_ports probe20_0] [get_bd_pins system_ila_0/probe20]
  connect_bd_net -net probe21_0_1 [get_bd_ports probe21_0] [get_bd_pins system_ila_0/probe21]
  connect_bd_net -net probe22_0_1 [get_bd_ports probe22_0] [get_bd_pins system_ila_0/probe22]
  connect_bd_net -net probe23_0_1 [get_bd_ports probe23_0] [get_bd_pins system_ila_0/probe23]
  connect_bd_net -net probe24_0_1 [get_bd_ports probe24_0] [get_bd_pins system_ila_0/probe24]
  connect_bd_net -net probe25_0_1 [get_bd_ports probe25_0] [get_bd_pins system_ila_0/probe25]
  connect_bd_net -net probe26_0_1 [get_bd_ports probe26_0] [get_bd_pins system_ila_0/probe26]
  connect_bd_net -net probe27_0_1 [get_bd_ports probe27_0] [get_bd_pins system_ila_0/probe27]
  connect_bd_net -net probe28_0_1 [get_bd_ports probe28_0] [get_bd_pins system_ila_0/probe28]
  connect_bd_net -net probe29_0_1 [get_bd_ports probe29_0] [get_bd_pins system_ila_0/probe29]
  connect_bd_net -net probe2_0_1 [get_bd_ports probe2_0] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net probe30_0_1 [get_bd_ports probe30_0] [get_bd_pins system_ila_0/probe30]
  connect_bd_net -net probe31_0_1 [get_bd_ports probe31_0] [get_bd_pins system_ila_0/probe31]
  connect_bd_net -net probe3_0_1 [get_bd_ports probe3_0] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net probe4_0_1 [get_bd_ports probe4_0] [get_bd_pins system_ila_0/probe4]
  connect_bd_net -net probe5_0_1 [get_bd_ports probe5_0] [get_bd_pins system_ila_0/probe5]
  connect_bd_net -net probe6_0_1 [get_bd_ports probe6_0] [get_bd_pins system_ila_0/probe6]
  connect_bd_net -net probe7_0_1 [get_bd_ports probe7_0] [get_bd_pins system_ila_0/probe7]
  connect_bd_net -net probe8_0_1 [get_bd_ports probe8_0] [get_bd_pins system_ila_0/probe8]
  connect_bd_net -net probe9_0_1 [get_bd_ports probe9_0] [get_bd_pins system_ila_0/probe9]
  connect_bd_net -net rst_ps8_0_49M_peripheral_aresetn [get_bd_pins rst_ps8_0_49M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_1/aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net xlconstant_0_dout1 [get_bd_pins xlslice_5/Dout] [get_bd_ports pl_reset_led] [get_bd_pins gig_ethernet_pcs_pma_0/reset]
  ...
  connect_bd_net -net xlconstant_5_dout [get_bd_pins constants/sfp_tx_dis] [get_bd_ports sfp_tx_dis]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_ports pcs_clk_led]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins xlslice_1/Dout] [get_bd_ports link_status_led]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins xlslice_2/Dout] [get_bd_ports link_sync_led]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins xlslice_3/Dout] [get_bd_ports mdc_clk_led]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins xlslice_4/Dout] [get_bd_ports gmii_rx_clk_led]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins gig_ethernet_pcs_pma_0/independent_clock_bufg] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_49M/slowest_sync_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihpc0_fpd_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_ports pl_clk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins rst_ps8_0_49M/ext_reset_in] [get_bd_ports pl_resetn]
