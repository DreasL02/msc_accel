 ...
 * limitations under the License.
 *
 * MODULE:      ACCEL MONITOR CONFIG
 * PROJECT:     Accelerating UVM testbenches using Co-Emulation in FPGAs
////////////////////////////////////////////////////////////////////////////////
*/

class accel_monitor_config extends uvm_object;
  `uvm_object_utils(accel_monitor_config)

  function new(string name = "accel_monitor_config");
    super.new(name);
  endfunction

  byte unsigned request_protocol_identifier = 0;

  byte unsigned response_protocol_identifier = 0;
